...
@Component({
  selector: 'app-telecaller-beat-dsr',
  templateUrl: './telecaller-beat-dsr.component.html',
  styleUrls: ['./telecaller-beat-dsr.component.scss']
})
export class TelecallerBeatDsrComponent implements OnInit {
...
//    }
//    else
	 if(this.SelectedCity!=undefined && this.FromDate==undefined && this.ToDate==undefined)
     {
      this.SelectedCity=this.AllCity
      this.CityId=[]
      this.StoreIdd=[]        
      ...
      {
        "CityIds":this.CityId,
        "Type":this.Type == 1 ? "Telecaller" : "Digital",
...
//    else
  ...
  Export()
  {
    ...
    this.SalesAppService.GetTelecallerBeatDSR(payload).subscribe(x=>
    {
      ...
      console.log(DigitalSalesBeatDSRMTDData);
      var exportData=[];
