...
@Component({
  selector: 'app-gullak-cash-back-details',
  templateUrl: './gullak-cash-back-details.component.html',
  styleUrls: ['./gullak-cash-back-details.component.scss']
})
export class GullakCashBackDetailsComponent implements OnInit {
  displayTabs: any[];
  closeResult: string;
@Input()Id :any;
@Input() details : any;
