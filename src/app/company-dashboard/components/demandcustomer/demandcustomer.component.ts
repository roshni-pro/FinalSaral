...
@Component({
  selector: 'app-demandcustomer',
  templateUrl: './demandcustomer.component.html',
  styleUrls: ['./demandcustomer.component.scss']
})
export class DemandcustomerComponent implements OnInit {
