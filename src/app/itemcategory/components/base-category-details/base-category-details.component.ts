...
@Component({
  selector: 'app-base-category-details',
  templateUrl: './base-category-details.component.html',
  styleUrls: ['./base-category-details.component.scss']
})
export class BaseCategoryDetailsComponent implements OnInit {
...
constructor(private modalService: NgbModal) {this.entity = "BaseCategory"; }
