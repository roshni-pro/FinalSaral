...
@Component({
  selector: 'app-category-image-details',
  templateUrl: './category-image-details.component.html',
  styleUrls: ['./category-image-details.component.scss']
})
export class CategoryImageDetailsComponent implements OnInit {
