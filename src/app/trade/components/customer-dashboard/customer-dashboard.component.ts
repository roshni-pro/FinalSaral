...
export class CustomerDashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    inputModel.CustomerId= this.customerId;
    ...
    // this.bidService.GetDemandOrStockCustomer(inputModel).subscribe(result => {
    //   this.demandList = result;
    //   console.log('this.demandList : ', this.demandList);
    //   //this.totalRecords = result.Count;
    //   this.isLoading = false;
    // });
    this.bidService.GetCustomerDemandOrStockForCustomer(inputModel).subscribe(result => {
      this.demandList = result;
      console.log('this.demandList : ', this.demandList);
      //this.totalRecords = result.Count;
      this.isLoading = false;
  ...
  getDemandData(inputModel) {
    ...
    this.bidService.GetDemandOrStockCustomerSummary(inputModel).subscribe(result => {
      console.log('GetDemandOrStockCustomerSummary is: ', result);
      let priceData = [];
      let volumeData = [];
