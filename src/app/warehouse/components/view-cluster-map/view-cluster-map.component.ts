...
@Component({
  selector: 'app-view-cluster-map',
  templateUrl: './view-cluster-map.component.html',
  styleUrls: ['./view-cluster-map.component.scss']
})
export class ViewClusterMapComponent implements OnInit {
