...
export class CashMgmtServicesService {
  ...
  GetRequestBtn(warehouseid, action, CashierPeopleId)
  {
    return this.http.get<any>(this.apiURL+'api/TestCashCollection/CMSCashierVerification?warehouseid='+warehouseid+'&action='+action+'&CashierPeopleId='+CashierPeopleId);
  }
}
