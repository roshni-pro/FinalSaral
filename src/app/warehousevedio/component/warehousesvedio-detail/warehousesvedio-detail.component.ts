...
@Component({
  selector: 'app-warehousesvedio-detail',
  templateUrl: './warehousesvedio-detail.component.html',
  styleUrls: ['./warehousesvedio-detail.component.scss']
})
export class WarehousesvedioDetailComponent implements OnInit {
  displayTabs: any[];
  closeResult: string;
@Input()Id:any;
@Input() details : any;
