...
@Component({
  selector: 'app-suppliercategory-details',
  templateUrl: './suppliercategory-details.component.html',
  styleUrls: ['./suppliercategory-details.component.scss']
})
export class SuppliercategoryDetailsComponent implements OnInit {
