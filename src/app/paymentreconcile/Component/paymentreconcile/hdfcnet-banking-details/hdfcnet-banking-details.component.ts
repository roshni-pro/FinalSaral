...
@Component({
  selector: 'app-hdfcnet-banking-details',
  templateUrl: './hdfcnet-banking-details.component.html',
  styleUrls: ['./hdfcnet-banking-details.component.scss']
})
export class HDFCNetBankingDetailsComponent implements OnInit {
  searchModel:any;
  gethdfc:any;
  ...
  this.PaymentreconcileService.GetHDFCNetdata(this.UploadId).subscribe(result=>{
  ...
  onValueChange(value) {
    ...
    this.PaymentreconcileService.GetStatusHDFCNet(this.UploadId,value).subscribe(res => {
      console.log(value);
      console.log(res)
