...
@Component({
  selector: 'app-gulakdetailspage',
  templateUrl: './gulakdetailspage.component.html',
  styleUrls: ['./gulakdetailspage.component.scss']
})
export class GulakdetailspageComponent implements OnInit {
  @Input() Id: any;
  displayTabs: any[];
  closeResult: string;
...
constructor(private modalService: NgbModal) { }
  ...
  onDelete(details){
    this.deleteSelected.emit(details.Cityid);
