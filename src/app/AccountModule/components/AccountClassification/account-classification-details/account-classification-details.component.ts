...
@Component({
  selector: 'app-account-classification-details',
  templateUrl: './account-classification-details.component.html',
  styleUrls: ['./account-classification-details.component.scss']
})
export class AccountClassificationDetailsComponent implements OnInit {
