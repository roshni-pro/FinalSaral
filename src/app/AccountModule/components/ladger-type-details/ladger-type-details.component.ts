...
@Component({
  selector: 'app-ladger-type-details',
  templateUrl: './ladger-type-details.component.html',
  styleUrls: ['./ladger-type-details.component.scss']
})
export class LadgerTypeDetailsComponent implements OnInit {
...
constructor(private modalService: NgbModal) { }
  ...
  onDelete(details){
    ...
    //PZ//this.modalService.dismissAll('done');
  }
