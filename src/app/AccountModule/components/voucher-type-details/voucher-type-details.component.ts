...
@Component({
  selector: 'app-voucher-type-details',
  templateUrl: './voucher-type-details.component.html',
  styleUrls: ['./voucher-type-details.component.scss']
})
export class VoucherTypeDetailsComponent implements OnInit {
