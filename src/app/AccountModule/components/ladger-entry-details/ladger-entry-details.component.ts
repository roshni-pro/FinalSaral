...
@Component({
  selector: 'app-ladger-entry-details',
  templateUrl: './ladger-entry-details.component.html',
  styleUrls: ['./ladger-entry-details.component.scss']
})
export class LadgerEntryDetailsComponent implements OnInit {
