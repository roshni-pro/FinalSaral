...
export class ClusterStoreBeatMappingService {
  ...
  getValidateClusterCustomer(details): Observable<string>{
    return this.httpClient.post<string>(this.apiURL + 'api/ClusterStoreBeatMapping/ValidateClusterCustomer', details);
  }

  uploadExcelSheet(uploadData): Observable<any>{
    return this.httpClient.post<any>(this.apiURL + 'api/ClusterStoreBeatMapping/Upload', uploadData);
  }
}
