...
@Component({
  selector: 'app-masterchecker-details',
  templateUrl: './masterchecker-details.component.html',
  styleUrls: ['./masterchecker-details.component.scss']
})
export class MastercheckerDetailsComponent implements OnInit {
